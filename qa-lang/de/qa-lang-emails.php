...
*/
	...
	return array(
		...
		'a_followed_body' => "Deine Antwort bei ^site_title hat eine neue ähnliche Idee von ^q_handle:\n\n^open^q_title^close erhalten.\n\nDeine Antwort war:\n\n^open^a_content^close\n\nKlicke auf den folgenden Link, um eine Antwort zu einer neuen Idee zu zu schreiben:\n^url\n\nVielen Dank,\n\n^site_title",
		'a_followed_subject' => 'Deine Antwort bei ^site_title hat eine ähnliche Idee',
		...
		'q_answered_body' => "^a_handle hat deine Idee bei ^site_title beantwortet:\n\n^open^a_content^close\n\nDeine Idee war:\n\n^open^q_title^close\n\nWenn die Antwort gut ist, kannst du sie als Beste auswählen:\n^url\n\nVielen Dank,\n\n^site_title",
		'q_answered_subject' => 'Deine Idee bei ^site_title wurde beantwortet',
		'q_commented_body' => "^c_handle hat deine Idee bei ^site_title kommentiert:\n\n^open^c_content^close\n\nDeine Idee war:\n\n^open^c_context^close\n\nDu kannst mit einem eigenen Kommentar antworten:\n^url\n\nVielen Dank,\n\n^site_title",
		'q_commented_subject' => 'Deine Idee bei ^site_title hat einen neuen Kommentar',
		'q_posted_body' => "^q_handle hat eine neue Idee gestellt\n\n^open^q_title\n\n^q_content^close\n\nKlicke auf den folgenden Link, um die Idee zu sehen:\n^url\n\nVielen Dank,\n\n^site_title",
		'q_posted_subject' => 'Bei ^site_title gibt es eine neue Idee',
